...
interface LiveMetrics {
  ...
  totalFeeUsdcWei6: string;             // Σ fill.feeUsdcWei6 (maker creation-fee shares); '0' until a producer emits that field (seed posting, a later slice)
}
