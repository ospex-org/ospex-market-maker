...
interface LiveMetrics {
  ...
  totalFeeUsdcWei6: string;             // Σ fill.feeUsdcWei6 — ESTIMATED maker seed creation-fee (conservative, may over-state by one fee per speculation another maker raced to create first; NOT folded into realizedPnl); '0' on any moneyline-only / seeding-off run
}
