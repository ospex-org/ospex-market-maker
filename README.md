...
- `yarn install && yarn build && yarn typecheck && yarn lint && yarn test` — clean (147 unit tests across the pricing, config, risk, orders, state, telemetry, ospex-adapter, and CLI-command modules).
