...
- `yarn install && yarn build && yarn typecheck && yarn lint && yarn test` — clean (285 unit tests across the pricing, config, risk, orders, state, telemetry, ospex-adapter, runner, and CLI-command modules).
