...
export function buildDesiredQuote(
  ...
  // The risk engine keys exposure by `market.speculationId` (the protocol's settlement
  // unit), so headroom here reserves room for the contest's other markets too (DESIGN §6).
  const headroomUSDC = {
